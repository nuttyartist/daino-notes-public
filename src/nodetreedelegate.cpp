...
void NodeTreeDelegate::setTheme(Theme::Value theme)
{
    ...
    case Theme::Light: {
        ...
        m_dateColor = QColor(69,67,69);
        m_defaultColor = QColor(237, 237, 237);
        //        m_ActiveColor = QColor(218, 233, 239);
        m_notActiveColor = QColor(175, 212, 228);
        m_hoverColor = QColor(237, 237, 237); // QColor(180, 208, 233);
        m_currentBackgroundColor = QColor(237, 237, 237);
    ...
    case Theme::Dark: {
        ...
        m_defaultColor = QColor(51, 51, 51);
        //        m_ActiveColor = QColor(0, 59, 148);
        m_notActiveColor = QColor(35, 52, 69);
        m_hoverColor = QColor(51, 51, 51); // QColor(35, 52, 69);
        m_currentBackgroundColor = QColor(51, 51, 51);
                             ...
                             const QModelIndex &index) const
{
    ...
    // Rectangle background not needed for now
    ...
    case NodeItem::Type::TrashButton: {
        ...
        auto iconRect = QRect(option.rect.x() + 27,
    ...
    case NodeItem::Type::TagSeparator: {
        ...
        textRect.moveLeft(textRect.x() + 9);
    ...
    case NodeItem::Type::FolderItem: {
        paintBackgroundSelectable(painter, option, index);
        auto iconRect = QRect(option.rect.x() + 15,
                                                 ...
                                                 const QModelIndex &index) const
{
    ...
    QRect adjustedRect = option.rect.adjusted(leftRightPadding, topBottomPadding, -leftRightPadding,
                                              -topBottomPadding);
    QPainterPath path;
                                        ...
                                        const QModelIndex &index) const
{
    ...
    if (itemType == NodeItem::Type::FolderSeparator || itemType == NodeItem::Type::TagSeparator) {
        ...
        layout->setContentsMargins(9, 7, 0, 0);
        ...
        addButton->setMaximumSize({ 30, 28 });
        addButton->setMinimumSize({ 30, 28 });
        ...
        case Theme::Dark: {
            addButton->setStyleSheet(QStringLiteral(R"(QPushButton { )"
                                               ...
                                               R"(QPushButton:hover { )"
                                               R"(    border-radius: 5px;)"
                                               R"(    background-color: rgb(49, 49, 49); )"
                                               R"(})"
                                               R"(QPushButton:pressed { )"
                                               R"(    background-color: rgb(44, 44, 44); )"
                                               R"(})"));
            break;
        }
        case Theme::Sepia: {
        ...
        layout->addSpacing(9);
        connect(this, &NodeTreeDelegate::themeChanged, addButton,
                &PushButtonType::setTheme);
        return widget;
